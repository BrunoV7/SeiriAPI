package com.seiri.domains.board.service;
...
public class BoardService {
    ...
    public BoardResponseFullDTO findBoardFull(UUID id) {
        if(boardRepository.getBoardById(id) == null) return null;
        return new BoardResponseFullDTO(boardRepository.getBoardById(id));
    }
}
